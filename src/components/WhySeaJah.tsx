          ...
          {KEYS.map((key, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative overflow-hidden bg-white rounded-xl p-6 border border-gray-100 hover:border-[#2DD4BF] hover:shadow-lg transition-all duration-300"
              >
                {/* Top accent line */}
                ...
                <div className="w-12 h-12 rounded-xl bg-[#F0FDFA] flex items-center justify-center mb-4 group-hover:bg-[#2DD4BF] transition-colors duration-300">
