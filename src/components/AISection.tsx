...
export default function AISection() {
  ...
  return (
    <section id="ai" className="py-24 bg-[#F0FDFA] dark:bg-[#042f2e]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#2DD4BF] bg-white dark:bg-[#0A0A0A] mb-6">
            <span className="text-[#2DD4BF] text-xs font-bold tracking-widest" style={{ fontFamily: "var(--font-dm-sans)" }}>
              ✦ AI CONSULTING
            </span>
          </div>
          <h2
            className="text-4xl md:text-6xl font-black text-[#0A0A0A] dark:text-[#FAFAFA] mb-4"
          ...
          {KEYS.map((key, i) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="bg-white dark:bg-[#141414] rounded-xl p-8 border border-[#2DD4BF]/20 dark:border-[#2DD4BF]/10 hover:border-[#2DD4BF] hover:shadow-lg transition-all duration-300 group"
              >
